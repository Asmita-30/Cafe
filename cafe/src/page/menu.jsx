...
const Menu = () => {
  ...
  const styles = {
    ...
    heroSection: {
      ...
      padding: '120px 20px',
      textAlign: 'center',
      background: `linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url(${homepageImg})`,
        ...
        <div style={styles.menuContainer}>
          <div style={styles.categoryHeader}>
            <h2 style={styles.categoryHeaderTitle}>
              {activeCategory === 'all' ? '🍽️ All Items 🍽️' : `${activeCategoryData?.icon} ${activeCategoryData?.name}`}
            </h2>
          ...
          {displayItems.length === 0 && (
            <div style={{ textAlign: 'center', padding: '80px', background: 'white', borderRadius: '30px' }}>
      ...
      <style>
        {`
          ...
          @media (max-width: 768px) {
            ...
            .categoriesContainer button { padding: 10px 18px !important; font-size: 13px !important; }
            .statsContainer { grid-template-columns: repeat(2, 1fr) !important; gap: 25px !important; }
            .heroTitle { font-size: 40px !important; }
            .heroSubtitle { font-size: 16px !important; }
            .categoryHeaderTitle { font-size: 32px !important; }
          }
        `}
      </style>
    </div>
