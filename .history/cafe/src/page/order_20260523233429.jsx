...
const Order = () => {
  ...
  const menuItems = [
    ...
    { id: 7, name: 'Iced Latte', price: 240, icon: '🧊', image: IcedLatte, category: 'Cold Coffee', isPopular: true },
    { id: 8, name: 'Grilled Cheese', price: 180, icon: '🥪', image: GrilledCheese, category: 'Sandwich', isPopular: true },
    { id: 9, name: 'Cold Coffee', price: 240, icon: '🧊', image: hotcoffie, category: 'Cold', isPopular: false },
    { id: 10, name: 'Butter Croissant', price: 120, icon: '🥐', image: homepageImg, category: 'Bakery', isPopular: true }
  ];
  ...
  const cardVariants = {
    ...
    hover: { y: -8, scale: 1.02, transition: { type: "spring", stiffness: 300 } }
  };
  ...
  const styles = {
    ...
    // Hero Section with REAL IMAGE - No overlay, no color effect
    heroSection: {
      position: 'relative',
      padding: '100px 20px',
      textAlign: 'center',
      backgroundImage: `url(${homepage2Img})`,
  ...
  return (
    <div style={styles.container}>
      {/* Hero Section with REAL IMAGE - No gradient overlay */}
...
export default Order;// src/page/order.jsx
import React, { useState, useEffect } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import homepageImg from '../assets/homepage.png';
import homepage2Img from '../assets/homepage2.png';
