  ...
  return (
    <>
              ...
              >
                {item.hasDropdown ? (
                  ...
                  <button 
                    ...
                    style={item.name === 'Order' ? styles.orderButton : styles.navLink}
                    onMouseEnter={(e) => {
                      if (item.name === 'Order') {
      ...
      <div style={styles.mobileMenu}>
        <button style={styles.closeButton} onClick={closeMobileMenu}>✕</button>
          ...
          <div key={item.name}>
            {item.hasDropdown ? (
              ...
              <button 
                ...
                style={{...styles.mobileNavLink, width: '100%', background: 'none', border: 'none', textAlign: 'left'}}
              >
