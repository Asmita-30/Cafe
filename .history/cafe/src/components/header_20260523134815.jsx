...
const Header = () => {
  ...
  const navItems = [
    ...
    { 
      ...
      hasDropdown: true,
      dropdownItems: [
        { name: '☕ Hot Coffee', href: '/menu/hot-coffee', price: '$3.50 - $6.00' },
        { name: '🧊 Cold Coffee', href: '/menu/cold-coffee', price: '$4.00 - $7.00' },
        { name: '🍵 Teas & Chai', href: '/menu/tea', price: '$3.00 - $5.00' },
        { name: '🥐 Bakery & Pastries', href: '/menu/bakery', price: '$2.50 - $8.00' },
        { name: '🥗 Breakfast', href: '/menu/breakfast', price: '$6.00 - $12.00' },
        { name: '🍝 Lunch & Dinner', href: '/menu/lunch', price: '$8.00 - $18.00' },
        { name: '🍰 Desserts', href: '/menu/desserts', price: '$4.00 - $9.00' },
        { name: '🥤 Smoothies & Shakes', href: '/menu/smoothies', price: '$5.00 - $8.00' },
        { name: '🍷 Special Drinks', href: '/menu/special', price: '$5.00 - $10.00' },
        { name: '🥪 Sandwiches & Wraps', href: '/menu/sandwiches', price: '$7.00 - $12.00' }
      ]
    },
  ...
  const styles = {
    ...
    dropdownArrow: {
      ...
      transform: isMenuDropdownOpen ? 'rotate(180deg)' : 'rotate(0)',
    },
    dropdownMenu: {
      position: 'absolute',
      top: '40px',
      ...
      <header style={styles.header}>
        <div style={styles.container}>
          ...
          <nav style={styles.desktopNav}>
            {navItems.map((item) => (
              <div key={item.name} style={styles.navItem} className="menu-dropdown">
                {item.hasDropdown ? (
                  <>
                    <button
                      style={{ ...styles.navLink, ...styles.dropdownBtn }}
                      ...
                      {item.dropdownItems.map((subItem) => (
                        ...
                        >
                          <div style={styles.dropdownItemContent}>
                            <span style={styles.dropdownItemName}>{subItem.name}</span>
                            <span style={styles.dropdownItemPrice}>{subItem.price}</span>
                          </div>
                        </a>
                      ))}
                    </div>
          ...
          <div key={item.name}>
            {item.hasDropdown ? (
              <>
                ...
                >
                  {item.name}
                  <span style={{ transform: isMobileMenuDropdownOpen ? 'rotate(180deg)' : 'rotate(0)', transition: 'transform 0.3s' }}>▼</span>
                </button>
                <div style={styles.mobileDropdownItems}>
                  {item.dropdownItems.map((subItem) => (
                    ...
                    >
                      <div>
                        <div style={{ fontWeight: '500' }}>{subItem.name}</div>
                        <div style={{ fontSize: '11px', color: '#b45309' }}>{subItem.price}</div>
                      </div>
                    </a>
                  ))}
                </div>
